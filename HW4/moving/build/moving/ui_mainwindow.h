...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(625, 417);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        MainWindowDesign->setWindowIcon(icon);
        MainWindowDesign->setStyleSheet(QString::fromUtf8("image: url(:/images/background.png);"));
        ...
        label->setGeometry(QRect(280, 290, 91, 61));
        label->setStyleSheet(QString::fromUtf8("image: url(:/images/icon.png);"));
