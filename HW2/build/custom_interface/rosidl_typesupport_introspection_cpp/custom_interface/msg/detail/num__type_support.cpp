...
{
  new (message_memory) custom_interface::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interface::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[2] = {
  {
    ...
    offsetof(custom_interface::msg::Num, message),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interface::msg::Num, num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  ...
  "Num",  // message name
  2,  // number of fields
  sizeof(custom_interface::msg::Num),
...
get_message_type_support_handle<custom_interface::msg::Num>()
{
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, msg, Num)() {
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
