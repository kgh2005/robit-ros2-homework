...
#include "custom_interface/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface::srv::AddThreeInts_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interface::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &custom_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::srv::AddThreeInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &custom_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
