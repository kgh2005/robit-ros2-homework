...
#include "custom_interface/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interface::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::msg::Num & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interface::msg::Num *>(
    untyped_ros_message);
...
{
  return &custom_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, msg, Num)() {
  return &custom_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
