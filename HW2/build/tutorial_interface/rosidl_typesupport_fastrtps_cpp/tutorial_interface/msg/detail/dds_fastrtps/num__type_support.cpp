...
#include "tutorial_interface/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interface::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interface::msg::Num & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interface::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interface::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interface::msg::Num *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_tutorial_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<tutorial_interface::msg::Num>()
{
  return &tutorial_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interface, msg, Num)() {
  return &tutorial_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
